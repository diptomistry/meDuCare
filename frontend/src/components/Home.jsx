    ...
    <div className="min-h-screen flex flex-col justify-center lg:px-32 px-5 text-white">
      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-3xl text-gray-700 font-extrabold tracking-tight leading-none md:text-5xl xl:text-5xl ">Shahid Buddhijibe Dr. Muhammad Mortaza Medical Centre</h1>
