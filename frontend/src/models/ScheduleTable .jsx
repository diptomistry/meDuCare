...
const ScheduleTable = ({ scheduleData }) => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-md "style={{ marginTop: '8rem' }}>
      <h2 className="text-2xl font-bold text-gray-700 mb-4">DU HEALTHCARE SCHEDULE</h2>
      <div className="flex flex-col">
        <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
            <div className="overflow-hidden">
              <table className="min-w-full border border-green-800 rounded-lg">
                <thead className="bg-backgroundColor/90 text-white">
                  <tr>
