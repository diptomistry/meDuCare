  ...
  const subMenusList = [
    {
      ...
      menus: ["Photo Gallery", "About Info", "Short Note", "Services", "Blogs","Citizen Charter","Notice"],
    },
    {
      name: "Users",
      icon: TbReportAnalytics,
      menus: ["Approve", "Update"],
    },
  ];
    ...
    <div>
      ...
      >
        <div className="flex items-center gap-2.5 font-medium border-b py-3 border-slate-300  mx-3">
          ...
          ></FaClinicMedical>
          <span className="text-xl whitespace-pre ml-2">DU HealthCare</span>
        </div>

        <div className="flex flex-col  h-full">
          <ul className="mt-5 whitespace-pre px-2.5 text-[0.9rem] py-5 flex flex-col gap-5  font-medium overflow-x-hidden scrollbar-thin scrollbar-track-white scrollbar-thumb-slate-100   md:h-[68%] h-[70%]">
            <li>
          ...
          {open && (
            <div className="flex-1 text-sm z-50  max-h-48 my-auto  whitespace-pre   w-full  font-medium  ">
              <div className="flex border-y border-slate-300 p-4 items-center justify-center">
                
                <p className="text-teal-500 py-1.5 px-3 text-xl bg-teal-50 rounded-xl">
                  Admin Panel
                </p>
              </div>
            </div>
